% Function from Greg Freeman's matlabPyrTools github
% Used as part of the imgradient replacement functions
...
% BPR Comment: Suppreses warning in the command prompt 
...
if (exist('edges') == 1) 
  if (strcmp(edges,'reflect1') ~= 1)
      % BPR Comment: Suppresses warning in the command prompt
